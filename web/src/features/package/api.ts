 ...
 *
 * @param channel channel/account name
...
/**
 * Fetches all packages by account/channel
 * @param channel channel/account name
 */
...
/**
 * Removes the package from the channel. The account must be signed in and must be the owner of the channel
